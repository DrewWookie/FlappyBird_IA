...
class Passaro:
    ...
    def mover(self):
        # Calculo de deslocamento ("Sorvetão")
        self.tempo += 1
    ...
    def desenhar(self, tela):
        # Definição das imagens do passáro
        ...
        # Na queda pássaro não bate as asas
        if self.angulo <= 80:
            self.imagem = self.IMGS[1]
